...
def get_argparser() -> argparse.ArgumentParser:
    ...
    # Logging
    arg_parser.add_argument('--Names', type=str, default=None, help="Name of the run")
    arg_parser.add_argument('--save_features', action='store_true', default=False, 
                            help="If true, save features (entropy, embeddings) for Active Learning")
